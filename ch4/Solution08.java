...
public class codingbootcamp {
	...
	public static void main(String[] args) {
		...
		System.out.println(s.lowestCommonAncestor(root, root, root.left.left).val);
		System.out.println(s.lowestCommonAncestor(root, root.left.right, root.left.left).val);
		System.out.println(s.lowestCommonAncestor(root, root.left.right, root.left.right).val);
		System.out.println(s.lowestCommonAncestor(root, root.left.right, root.right.left).val);
	}
}
