...
public class codingbootcamp {
	...
	public int dfs(TreeNode root) {
		...
		if (flag == false)
			return 0;
		if (root.left == null && root.right == null) // height of leaf node = 1
			return 1;
		int left_h = dfs(root.left); // get height of left and right subtree
		int right_h = dfs(root.right); // then compare
